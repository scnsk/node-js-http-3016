    ...
    switch (req.method) {
      case 'GET':
        if (req.url === '/') {
          ...
          res.write(`<!DOCTYPE html><html lang="ja"><body><h1>アンケート一覧</h1><ul><li><a href="/enquetes/yaki-tofu">焼き肉・湯豆腐</a></li><li><a href="/enquetes/rice-bread">ごはん・パン</a></li><li><a href="/enquetes/sushi-pizza">寿司・ピザ</a></li></ul></body></html>`);
